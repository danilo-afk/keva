...
> = {
  authentication: {
    description:
      "Kiara could not authenticate with this repository. Check your access and try again.",
    title: "Repository access failed",
  },
  missing: {
    description:
      "The project announcement exists, but its git repository was not found on the Kiara relay.",
  ...
  network: {
    description:
      "The Kiara git service could not be reached. Check your connection and try again.",
  ...
  unknown: {
    description:
      "Kiara could not load this repository. Try again or contact the project owner.",
