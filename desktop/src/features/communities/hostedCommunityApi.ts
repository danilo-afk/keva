...
export function hostedCommunityErrorMessage(
  ...
  const messages: Record<string, string> = {
    missing_mapping: "Connect your Kiara identity before creating a community.",
    invalid_name: "Use lowercase letters, numbers, and hyphens.",
    taken: "That Kiara address is already taken.",
    ...
    identity_already_bound:
      "This Builderlab account is connected to another Kiara identity.",
    pubkey_already_bound:
      "This Kiara identity is connected to another Builderlab account.",
    not_owner: "Only the community owner can do that.",
    transferee_not_registered:
      "That person needs a connected Kiara identity before you can transfer ownership to them.",
  };
  ...
  if (
    ...
    throw new Error(
      hostedCommunityErrorMessage(
        ...
        "Could not load the connected Kiara identity.",
      ),
    );
  }
